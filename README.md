...
| `/users`                    | Lista, criação e edição de usuários (S19); soft-delete; **card de cobertura geográfica** com autocomplete IBGE (UF/cidade, S24) + **bairro via Nominatim/OSM** (S35)                                 |
